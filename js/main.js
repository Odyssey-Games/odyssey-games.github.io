// https://www.npmjs.com/package/detectos.js
class DetectOS {
    constructor() {
...
function download_latest(project) {
    const operating_system = Detect.OS;
    const file_name = operating_system === "Windows" ? "client.exe" : "client";
    const download_link = "https://github.com/Odyssey-Games/" + project + "/releases/download/latest-" + operating_system.toLowerCase() + "/" + file_name;
